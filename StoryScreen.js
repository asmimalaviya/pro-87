...
const styles = StyleSheet.create({
  ...
  appTitleTextLight: { color: "black", fontSize: RFValue(28), fontFamily: "Bubblegum-Sans" },
  ...
  storyCardLight: { margin: RFValue(20), backgroundColor: "white", borderRadius: RFValue(20), shadowColor: "rgb(0, 0, 0)", shadowOffset: { width: 3, height: 3 },
  ...
  storyTitleTextLight: { fontFamily: "Bubblegum-Sans", fontSize: RFValue(25), color: "black" },
  ...
  storyAuthorTextLight: { fontFamily: "Bubblegum-Sans", fontSize: RFValue(18), color: "black" },
  ...
  storyTextLight: { fontFamily: "Bubblegum-Sans", fontSize: RFValue(15), color: "black" },
  ...
  moralTextLight: { fontFamily: "Bubblegum-Sans", fontSize: RFValue(20), color: "black" },
  ...
  likeTextLight: { fontFamily: "Bubblegum-Sans", fontSize: RFValue(25), marginLeft: RFValue(5) },
